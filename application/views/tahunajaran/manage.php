			  ...
			  <div class="panel-body">
				<div class="form-horizontal" >
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
						  <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control"  required="required"  id="thn_ajaran" placeholder="input tahun ajaran" name="thn_ajaran" value="<?php echo $data->thn_ajaran; ?>"  >
						</div>
					</div>
				</div>
			  </div>
