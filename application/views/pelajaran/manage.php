			  ...
			  <div class="panel-body">
				<div class="form-horizontal" >
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
						  <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" id="kkm" name="kkm" placeholder="input kkm" required="required" value="<?php echo $data->kkm; ?>">
						</div>
					</div>
				</div>
			  </div>
