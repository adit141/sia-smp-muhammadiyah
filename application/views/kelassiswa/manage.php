...
<div id="body-container">
	<div class="container">
		...
		<?php endif; ?>
		<form  method="post" action="<?php echo site_url("kelassiswa/save")?>"  >
			<input type="hidden" class="form-control" id="id" name="id" value="<?php echo $data->id_tempati; ?>" >
			  			...
			  			<div class="col-md-4  pull-right">
			  				<div class="form-action pull-right">
								...
								<button type="submit" class="btn btn-success" name="action" value="saveexit">Save & Exit</button>
			     				...
			     				<a  href="<?php echo site_url("kelassiswa")?>" class="btn btn-danger">Cancel</a>
			     			</div>
			  			</div>
			  		</div>
			  </div>
			  <div class="panel-body">
				<div class="form-horizontal" >
					...
					<div class="form-group">
					    ...
					    <div class="col-sm-3">
							<input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" required="required" id="no_absen" placeholder="input no absen" name="no_absen" value="<?php echo $data->no_absen; ?>"  />
					    </div>
					</div>
				</div>
			  </div>
