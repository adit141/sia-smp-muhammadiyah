						...
						<div class="col-md-6">
							<div class="form-horizontal" >
								<div class="form-group">
									...
									<div class="col-sm-8">
									  <input type="text" class="form-control" id="nis" placeholder="input nis" name="nis" required="required" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  value="<?php echo $data->nis;?>"  <?php  echo $data->nis != '' ? 'readonly' :'' ?> >
									</div>
								</div>
								<div class="form-group">
									<label for="nis_nasional" class="col-sm-4 control-label">NIS Nasional</label>
									<div class="col-sm-8">
									  <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" id="nis_nasional" required="required" placeholder="input nis nasional" name="nis_nasional" value="<?php echo $data->nis_nasional; ?>"  >
									</div>
								</div>
								<div class="form-group">
						...
						<div class="col-md-6">
							<div class="form-horizontal" >
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
									  <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control"  required="required"  id="anak_ke" name="anak_ke" placeholder="input anak ke" value="<?php echo $data->anak_ke; ?>">
									</div>
								</div>
								<div class="form-group">
									<label for="tahun_masuk" class="col-sm-4 control-label">Tahun masuk</label>
									<div class="col-sm-4">
									  <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control"  required="required" id="tahun_masuk" name="tahun_masuk" placeholder="input tahun masuk" value="<?php echo $data->tahun_masuk; ?>">
									</div>
								</div>
								<div class="form-group">
									<label for="tahun_keluar" class="col-sm-4 control-label">Tahun Keluar</label>
									<div class="col-sm-4">
									  <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" id="tahun_keluar" name="tahun_keluar" placeholder="input tahun keluar" value="<?php echo $data->tahun_keluar; ?>">
									</div>
								</div>
								<div class="form-group">
						...
						<table class="table siswa-manage">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="col-sm-8">
											<input type="telp_bapak" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" id="telp_bapak" name="telp_bapak" placeholder="input telepon bapak" value="<?php echo $data->telp_bapak; ?>">
										</div>
									</td>
									<td>
										<div class="col-sm-8">
											<input type="telp_ibu" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" id="telp_ibu" name="telp_ibu" placeholder="input telepon ibu" value="<?php echo $data->telp_ibu; ?>">
										</div>
									</td>
								</tr>
							</tbody>
					  ...
					  <div class="panel-body">
						<div class="form-horizontal" >
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
								  <input type="telp_wali" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" id="telp_wali" name="telp_wali" placeholder="input telepon wali" value="<?php echo $data->telp_wali; ?>">
								</div>
							</div>
							<div class="form-group">
