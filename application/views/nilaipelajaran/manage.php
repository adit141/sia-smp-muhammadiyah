			  ...
			  <div class="panel-body">
				<div class="form-horizontal" >
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
						  <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" id="nilai" placeholder="input nilai" required="required" name="nilai" value="<?php echo $data->nilai; ?>"  >
						</div>
					</div>
<!--					<div class="form-group">
